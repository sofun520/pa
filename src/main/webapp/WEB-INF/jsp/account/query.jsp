...
<meta
	...
	name="viewport">
<link rel="stylesheet" href="${baseDir}/bootstrap/css/bootstrap.css">
<link rel="stylesheet"
							...
							<form action="query.do" method="post">
								...
								<div class="col-sm-12">
									...
									<button type="button" onclick="addDialog()"
										...
										<i class="fa fa-fw fa-plus"></i>新增流水账信息
									</button>
								</div>
							</form>
						</div>
...
table-striped table-hover dataTable">
							<tbody>
								...
								<c:if test="${list!=null}">
									<c:forEach var="ac" items="${list}" varStatus="xh">
										<tr>
											<td><c:out value="${xh.count}" /></td>
											<td align="right"><c:out value="${ac.aAmount}" /></td>
											<td><c:out value="${ac.aRemark}" /></td>
											<td><fmt:formatDate value="${ac.aDate}"
													pattern="yyyy-MM-dd" /></td>
											<td><a href="delete.do?id=${ac.aId}"><i
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h5 class="modal-title">新增流水账信息</h5>
				</div>
					...
					<form class="form-horizontal" id="addForm" method="post"
						...
						<div class="box-body">
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" name="aAmount" class="form-control input-sm"
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" name="aRemark" class="form-control input-sm"
										id="inputEmail3">
								</div>
								<div class="col-sm-2"></div>
							</div>
